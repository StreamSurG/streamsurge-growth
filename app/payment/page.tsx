        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-purple-500/20 bg-[#101010] p-10">
            ...
            <a
              ...
              className="mt-10 flex w-full items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-purple-600 to-fuchsia-600 py-4 font-bold transition hover:opacity-90"
            >
          ...
          <div className="rounded-3xl border border-green-500/20 bg-[#101010] p-10">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-8 flex w-full items-center justify-center rounded-2xl bg-green-600 py-4 font-bold transition hover:bg-green-700"
            >
              Pay with Cash App
            </a>
            ...
            <Link
              href="/requirements"
              className="mt-4 flex w-full items-center justify-center rounded-2xl border border-white/10 py-4 transition hover:bg-white/5"
            >
